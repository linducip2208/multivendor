...
class CompleteDemoSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $providers = [
            ...
            ['name'=>'Tripay Sandbox','type'=>'payment','api_format'=>'tripay-closed','base_url'=>'https://tripay.co.id/api-sandbox','is_active'=>true,'config'=>json_encode(['merchant_code'=>'T50251']),'description'=>'Tripay Closed — isi API Key + Private Key'],
            ...
            ['name'=>'DeepSeek AI','type'=>'ai','api_format'=>'openai-compatible','base_url'=>'https://api.deepseek.com/v1','is_active'=>true,'config'=>json_encode(['default_model'=>'deepseek-chat']),'description'=>'DeepSeek — isi API Key'],
            ['name'=>'OpenAI','type'=>'ai','api_format'=>'openai-compatible','base_url'=>'https://api.openai.com/v1','is_active'=>true,'config'=>json_encode(['default_model'=>'gpt-4.1-nano']),'description'=>'OpenAI — isi API Key'],
            ['name'=>'Groq','type'=>'ai','api_format'=>'openai-compatible','base_url'=>'https://api.groq.com/openai/v1','is_active'=>true,'config'=>json_encode(['default_model'=>'llama-4-scout-17b-16e-instruct']),'description'=>'Groq — isi API Key'],
            ['name'=>'Ollama (Self-hosted)','type'=>'ai','api_format'=>'openai-compatible','base_url'=>'http://localhost:11434/v1','is_active'=>false,'config'=>json_encode(['default_model'=>'llama3.2']),'description'=>'Ollama self-hosted — gratis, tanpa API key'],
            ['name'=>'OpenRouter','type'=>'ai','api_format'=>'openai-compatible','base_url'=>'https://openrouter.ai/api/v1','is_active'=>true,'config'=>json_encode(['default_model'=>'openai/gpt-4.1-nano']),'description'=>'OpenRouter — isi API Key'],
