...
<head>
    ...
    <style>
        ...
        .btn-login:hover { transform: translateY(-1px); box-shadow: 0 6px 24px rgba(79,70,229,.4); }
        .demo-box { background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 14px; }
    ...
    <div class="col-lg-7 d-flex align-items-center justify-content-center p-4">
        <div class="card login-form-card w-100" style="max-width:460px;">
            <div class="card-body p-5">
                ...
                <p class="text-muted mb-4">Panel administrasi multivendor</p>
