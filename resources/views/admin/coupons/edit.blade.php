...
@section('content')
<div class="mb-4"><a href="{{ route('admin.coupons.index') }}" class="small"><i class="fas fa-arrow-left me-1"></i>Kembali</a><h4 class="fw-bold mt-2">Edit Kupon: {{ $coupon->code }}</h4></div>
