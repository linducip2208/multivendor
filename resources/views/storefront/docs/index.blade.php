...
<head>
    ...
    <style>
        ...
        .screenshot-box{background:#1e293b;border-radius:12px;padding:16px;margin:16px 0;text-align:center;color:#94a3b8;font-size:.85rem;border:2px dashed #334155}
        .screenshot-box i{font-size:2rem;margin-bottom:8px;display:block}
...
<div class="container py-4"><div class="row g-4">
    ...
    <div class="col-lg-9">
        ...
        <div class="content-section" id="admin">
            ...
            <div class="screenshot-box"><i class="fas fa-image"></i>Screenshot: Halaman Login Admin — two-column branded login dengan hero panel kiri (gradient ungu) dan form login kanan. Terdapat demo login box di bawah form.</div>
            ...
            <div class="screenshot-box"><i class="fas fa-image"></i>Screenshot: Dashboard Admin — 5 stat cards (Vendor, Pelanggan, Produk, Pesanan, Pendapatan), alert cards warna-warni, tabel pesanan terbaru, sidebar navigasi lengkap</div>
            ...
            <div class="screenshot-box"><i class="fas fa-image"></i>Screenshot: Halaman Tambah Provider — dropdown tipe (Payment/Shipping/AI), dropdown format API, tombol autofill preset, field API key dan secret, toggle aktif</div>
            ...
            <div class="screenshot-box"><i class="fas fa-image"></i>Screenshot: Halaman Vendor — tabel dengan kolom Toko, Vendor, Kontak, Komisi, Status. Ada filter search + status dropdown. Tombol Tambah Vendor di kanan atas.</div>
            ...
            <div class="screenshot-box"><i class="fas fa-image"></i>Screenshot: Halaman Moderasi Produk — tabel produk dengan thumbnail, nama, toko, harga, stok, status badge (warning/success/danger). Dropdown aksi: Detail, Approve, Suspend, Hapus.</div>
            ...
            <div class="screenshot-box"><i class="fas fa-image"></i>Screenshot: Halaman Flash Deal — judul, tanggal mulai/berakhir, grid produk dengan checkbox dan diskon per produk</div>
            ...
            <div class="screenshot-box"><i class="fas fa-image"></i>Screenshot: Halaman Pesanan — status overview cards (Pending, Confirmed, Processing, Shipped, Delivered, Canceled), tabel pesanan dengan filter search + payment status</div>
            ...
            <div class="screenshot-box"><i class="fas fa-image"></i>Screenshot: Halaman Laporan — stats overview, AI Analysis section dengan dropdown provider + model + tombol fetch models + tombol Analisis. Di bawahnya tabel Top 15 Produk Terlaris.</div>
        ...
        <div class="content-section" id="vendor">
            ...
            <div class="screenshot-box"><i class="fas fa-image"></i>Screenshot: Halaman Login Vendor — two-column branded login dengan hero panel kiri (gradient hijau) dan 3 benefit card (Kelola Produk, Proses Pesanan, Pantau Penjualan). Form login kanan + demo box + tombol Vacation Mode.</div>
            ...
            <div class="screenshot-box"><i class="fas fa-image"></i>Screenshot: Dashboard Vendor — 5 stat cards hijau, tabel pesanan terbaru, tombol Vacation Mode toggle di kanan atas</div>
            ...
            <div class="screenshot-box"><i class="fas fa-image"></i>Screenshot: Form Tambah Produk — step wizard (1-5), Quill editor untuk deskripsi, field nama, kategori, brand, harga, stok, upload foto utama, upload foto tambahan (max 5), upload video (URL + file), dynamic variant rows, SEO meta title & description, tags input</div>
            ...
            <div class="screenshot-box"><i class="fas fa-image"></i>Screenshot: POS Screen — grid produk kiri, keranjang kanan, input customer name, diskon, payment method, tombol Bayar hijau besar</div>
            ...
            <div class="screenshot-box"><i class="fas fa-image"></i>Screenshot: Wallet Vendor — saldo besar, form pencairan (jumlah, bank, rekening, atas nama), tab riwayat transaksi + riwayat pencairan</div>
        ...
        <div class="content-section" id="customer">
            ...
            <div class="screenshot-box"><i class="fas fa-image"></i>Screenshot: Homepage — hero section dengan gradient ungu, search CTA, Deal of the Day kuning, Featured Products grid, Flash Deals section, Features grid 4×4, Demo Accounts table, Footer</div>
            ...
            <div class="screenshot-box"><i class="fas fa-image"></i>Screenshot: Product Listing — sidebar filter kategori + harga, grid produk 4 kolom dengan foto, nama toko, nama produk, harga, rating stars, discount badge merah, produk featured dengan bintang</div>
            ...
            <div class="screenshot-box"><i class="fas fa-image"></i>Screenshot: Product Detail — foto besar dengan discount badge, thumbnail gallery, video section, varian selector, info cards grid, reviews dengan bintang, form submit review, related products</div>
            ...
            <div class="screenshot-box"><i class="fas fa-image"></i>Screenshot: Cart — grouped per toko dengan nama toko, item dengan thumbnail + nama + harga + qty input + tombol hapus, subtotal per toko, ringkasan belanja + total + tombol Checkout</div>
            ...
            <div class="screenshot-box"><i class="fas fa-image"></i>Screenshot: Checkout — alamat radio buttons, pesanan per toko, shipping dropdown per toko, coupon input, payment gateway radio buttons, total, tombol Bayar Sekarang</div>
