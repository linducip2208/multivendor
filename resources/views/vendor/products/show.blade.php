...
<div class="row g-4">
    <div class="col-md-8"><div class="card border-0 rounded-4 shadow-sm"><div class="card-body p-4">
        @if($product->thumbnail)<div class="text-center mb-3"><img src="{{ asset('storage/'.$product->thumbnail) }}" class="rounded-4" style="max-width:100%;max-height:350px;object-fit:cover;"></div>@endif
